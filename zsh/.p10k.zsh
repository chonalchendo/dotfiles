# Generated by Powerlevel10k configuration wizard on 2024-05-14 at 23:03 BST.
...
# 2 lines, dotted, full frame, darkest-ornaments, sparse, few icons, concise,
...
() {
  ...
  ################################[ prompt_char: prompt symbol ]################################
  # Green prompt symbol if the last command succeeded. (Catppuccin Green)
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=120
  # Red prompt symbol if the last command failed. (Catppuccin Red/Maroon)
  ...
  ##################################[ dir: current directory ]##################################
  # Default current directory color. (Catppuccin Lavender - pastel purple)
  ...
  # Color of the shortened directory segments. (Catppuccin Overlay)
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=183
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor. (Catppuccin Blue - pastel)
  ...
  # Execution time color. (Catppuccin Yellow)
